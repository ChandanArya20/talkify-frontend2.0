...
const NewGroup = ({ closeNewGroup, closeOpenCreateGroup, groupMembersId }) => {
    ...
    const createNewGroup = () => {
        if (groupSubject.trim().length > 0) {
            // Dispatch action to create group chat
            dispatch(
                createGroupChat({
                    groupName: groupSubject,
                    groupImage: groupImage,
                    membersId: groupMembersId,
                })
            )
            closeNewGroup()
    ...
    // Function to add emoji to group subject
        ...
        <div className="flex flex-col justify-between w-full h-full">
            ...
            <div className="w-full flex-1 overflow-y-scroll p-5 md:p-8 ">
                ...
                <div className="mt-28 relative">
                    {loading && (
                        <ClipLoader color="#ddd" className="absolute" />
                    )}
