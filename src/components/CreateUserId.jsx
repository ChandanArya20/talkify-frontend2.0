    ...
    return (
        <div className="w-full md:w-[50%] px-5 md:px-8">
            <form onSubmit={handleSignup}>
                ...
                <h1 className="text-base font-medium text-center mt-4 mb-2 dark:text-gray-200">Make a User id</h1>
                ...
                {
                    useridAvailable &&
                    <p className="text-red-600 text-sm">The id '{userid}' is already taken by some other user, try different...</p>
                }
                <div className="w-full flex justify-end mt-4 space-x-2">
                    ...
                    <button  className="px-5 py-2 bg-[#379ee2] rounded-full text-gray-100 text-base relative disabled:disabled:cursor-not-allowed" disabled={userid.length < 3 || useridAvailable}>
                        Finish
                    </button>
                </div>
            </form>
